package com.example.relationshipmanager.viewmodels
...
import com.example.relationshipmanager.workers.EventWorker
...
class MainViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun scheduleNextCheck() {
        val workHour = sharedPrefs.getString("notification_hour", "17")!!.toInt()
        val workMinute = sharedPrefs.getString("notification_minute", "46")!!.toInt()
